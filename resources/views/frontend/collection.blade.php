...
<section class="bg-white py-12 md:py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-wrap justify-center gap-4 md:gap-8 px-2">
            ...
            <!-- Gommages gourmands -->
            <a href="#gommages" onclick="showCollection('gommages')" class="group relative bg-[#f9f5f0] rounded-xl md:rounded-2xl p-4 md:p-8 w-full sm:w-64 md:w-72 text-center shadow-md md:shadow-lg hover:shadow-xl md:hover:shadow-2xl hover:-translate-y-1 md:hover:-translate-y-3 transition-all duration-300 md:duration-500 ease-out overflow-hidden">
                ...
                <p class="text-gray-600 font-elegant text-xs md:text-sm leading-relaxed">
                    Exfoliation douce et textures gourmandes pour un éclat naturel.
                </p>
            ...
            <a href="#capillaires" onclick="showCollection('capillaires')" class="group relative bg-[#f9f5f0] rounded-xl md:rounded-2xl p-4 md:p-8 w-full sm:w-64 md:w-72 text-center shadow-md md:shadow-lg hover:shadow-xl md:hover:shadow-2xl hover:-translate-y-1 md:hover:-translate-y-3 transition-all duration-300 md:duration-500 ease-out overflow-hidden">
                <h3 class="text-lg md:text-xl font-luxury text-gray-900 mb-2 md:mb-3 group-hover:text-[#b88b55] transition-colors duration-300">
                    Produits capillaires
                </h3>
                <p class="text-gray-600 font-elegant text-xs md:text-sm leading-relaxed">
                    Soins riches et naturels pour tous types de cheveux.
                </p>
                <div class="absolute inset-0 border border-transparent group-hover:border-[#b88b55]/20 rounded-xl md:rounded-2xl transition-all duration-300 md:duration-500"></div>
            </a>

            <!-- Routine visage -->
            <a href="#visage" onclick="showCollection('visage')" class="group relative bg-[#f9f5f0] rounded-xl md:rounded-2xl p-4 md:p-8 w-full sm:w-64 md:w-72 text-center shadow-md md:shadow-lg hover:shadow-xl md:hover:shadow-2xl hover:-translate-y-1 md:hover:-translate-y-3 transition-all duration-300 md:duration-500 ease-out overflow-hidden">
                <h3 class="text-lg md:text-xl font-luxury text-gray-900 mb-2 md:mb-3 group-hover:text-[#b88b55] transition-colors duration-300">
                    Routine visage
                </h3>
                <p class="text-gray-600 font-elegant text-xs md:text-sm leading-relaxed">
                    Soins complets pour une peau lumineuse et hydratée.
                </p>
                <div class="absolute inset-0 border border-transparent group-hover:border-[#b88b55]/20 rounded-xl md:rounded-2xl transition-all duration-300 md:duration-500"></div>
            </a>
...
<script>
    ...
    const collections = {
        gommages: {
            title: "Gommages Gourmands",
            description: "Exfoliation douce aux textures gourmandes et parfums naturels pour une peau lumineuse.",
            products: [
                { id: 1, name: "Gommage Miel & Amande", description: "Exfoliant doux au miel et poudre d'amande pour une peau douce comme la soie. Formulé avec des ingrédients 100% naturels.", price: 24.99, image: "{{ asset('image/num.png') }}", color: "bg-amber-50" },
                { id: 2, name: "Gommage Café & Cacao", description: "Gommage énergisant au café et cacao bio pour réveiller votre peau. Parfait pour une exfoliation en douceur.", price: 26.50, image: "{{ asset('image/num1.png') }}", color: "bg-amber-100" },
                { id: 3, name: "Gommage Sucre Vanillé", description: "Exfoliant sucré à la vanille de Madagascar pour une peau parfumée et radieuse. Texture gourmande.", price: 22.99, image: "{{ asset('image/num.png') }}", color: "bg-yellow-50" },
                { id: 4, name: "Gommage Fleur d'Oranger", description: "Gommage délicat parfumé fleur d'oranger pour une peau douce et lumineuse. Effet apaisant garanti.", price: 27.99, image: "{{ asset('image/num1.png') }}", color: "bg-pink-50" },
                { id: 5, name: "Gommage Sel Marin", description: "Exfoliant purifiant au sel marin et algues. Idéal pour les peaux à imperfections.", price: 29.99, image: "{{ asset('image/num.png') }}", color: "bg-blue-50" },
                { id: 6, name: "Gommage Noix de Coco", description: "Gommage nourrissant à la noix de coco pour une peau hydratée et douce.", price: 25.50, image: "{{ asset('image/num1.png') }}", color: "bg-white" }
            ]
        },
        capillaires: {
            title: "Produits Capillaires",
            description: "Soins naturels pour cheveux brillants, forts et pleins de vie.",
            products: [
                { id: 7, name: "Shampoing Doux Argan", description: "Shampoing naturel à l'huile d'argan pour des cheveux brillants et soyeux.", price: 18.99, image: "{{ asset('image/capillaire.png') }}", color: "bg-blue-50" },
                { id: 8, name: "Après-shampoing Karité", description: "Après-shampoing nourrissant au beurre de karité pour des cheveux doux et disciplinés.", price: 21.99, image: "{{ asset('image/capillaire.png') }}", color: "bg-purple-50" },
                { id: 9, name: "Masque Réparateur Intense", description: "Masque intense réparation aux huiles essentielles pour cheveux abîmés.", price: 32.99, image: "{{ asset('image/capillaire.png') }}", color: "bg-indigo-50" },
                { id: 10, name: "Huile Capillaire Brillance", description: "Huile légère pour pointes et brillance. Ne graisse pas les cheveux.", price: 28.50, image: "{{ asset('image/capillaire.png') }}", color: "bg-amber-50" },
                { id: 11, name: "Spray Hydratant Quotidien", description: "Spray quotidien hydratation et démêlage pour des cheveux faciles à coiffer.", price: 16.99, image: "{{ asset('image/capillaire.png') }}", color: "bg-green-50" },
                { id: 12, name: "Gel Coiffant Naturel", description: "Gel fixant naturel aux extraits de lin pour des coiffures naturelles.", price: 14.99, image: "{{ asset('image/capillaire.png') }}", color: "bg-gray-50" }
            ]
        },
        visage: {
            title: "Routine Visage",
            description: "Soins complets pour une peau hydratée, lumineuse et éclatante.",
            products: [
                { id: 13, name: "Nettoyant Doux Rose", description: "Nettoyant visage à l'eau florale de rose pour une peau propre et fraîche.", price: 19.99, image: "{{ asset('image/routine.png') }}", color: "bg-pink-50" },
                { id: 14, name: "Sérum Éclat Vitaminé", description: "Sérum vitaminé pour un teint lumineux et une peau revitalisée.", price: 34.99, image: "{{ asset('image/routine.png') }}", color: "bg-yellow-50" },
                { id: 15, name: "Crème Hydratante Intense", description: "Crème jour/nuit hydratation intense pour une peau nourrie 24h/24.", price: 29.99, image: "{{ asset('image/routine.png') }}", color: "bg-blue-50" },
                { id: 16, name: "Masque Détente Argile", description: "Masque visage argile verte et menthe pour purifier et apaiser la peau.", price: 24.50, image: "{{ asset('image/routine.png') }}", color: "bg-green-50" },
                { id: 17, name: "Baume à Lèvres Miel", description: "Baume nourrissant au miel et cire d'abeille pour des lèvres douces.", price: 9.99, image: "{{ asset('image/routine.png') }}", color: "bg-amber-50" },
                { id: 18, name: "Contour des Yeux Concombre", description: "Soin anti-fatigue au concombre pour un regard frais et reposé.", price: 27.99, image: "{{ asset('image/routine.png') }}", color: "bg-white" }
            ]
        },
        savons: {
